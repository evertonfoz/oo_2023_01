namespace CC53
{
    class Program
    {
        static string SolicitarNomeDoUsuario()
        {
        ...
        static void ExibirNomeDoUsuario(string nomeDoUsuario)
        {
        ...
        static void Main(String[] args)
        {
            ...
            //string nomeDoUsuario = SolicitarNomeDoUsuario();

            //ExibirNomeDoUsuario(nomeDoUsuario);

            //string nomeDoUsuario = ;

            ExibirNomeDoUsuario(SolicitarNomeDoUsuario());
