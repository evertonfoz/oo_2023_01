...
namespace Aula_03
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                Estudante estudanteInstaciado =
                    instanciarEstudanteAtual(tbRA.Text, tbNome.Text);
                estudanteInstaciado.Endereco = endereco;
        ...
        {
            using (FrmEndereco frmEndereco = new())
            {
                frmEndereco.ShowDialog();
               //lblEndereco.Text =  frmEndereco.Endereco.Rua;
               // lblEndereco.Visible = true;
                endereco = new()
                {
                    Rua = frmEndereco.Endereco.Rua,
                };
